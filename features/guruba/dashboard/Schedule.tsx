        ...
        if (availability) {
            ...
            DAYS_OF_WEEK.forEach((_, index) => {
                ...
                initialSchedule[index] = found
                    ...
                    : { start: '05:00', end: '18:00', enabled: false }; // Default: 5 AM - 6 PM
            });
        ...
        <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {DAYS_OF_WEEK.map((day, idx) => (
                    <div
                        key={day}
                        className={`relative p-5 rounded-2xl border transition-all duration-300 flex flex-col gap-4 ${schedule[idx]?.enabled
