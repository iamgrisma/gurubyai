        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
                ...
                <textarea 
                    ...
                    rows={3}
                    className="w-full rounded-md border border-stone-300 p-2 text-sm focus:ring-saffron-500 focus:border-saffron-500"
                    placeholder="Share details about the ritual..."
                />
            </div>

            <Button type="submit" className="w-full" isLoading={loading}>Submit Review</Button>
        </form>
      </div>
    </div>
  );
