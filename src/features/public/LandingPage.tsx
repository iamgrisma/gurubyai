         ...
         <section className="relative pt-20 md:pt-32 pb-12 md:pb-20 overflow-hidden min-h-[90vh] md:min-h-screen flex items-center">
            ...
            <div className="container relative z-10 mx-auto px-4 md:px-6">
               ...
               <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4 items-stretch sm:items-center px-4 sm:px-0 mb-12 md:mb-20 animate-in fade-in zoom-in-95 duration-1000 delay-500">
                  ...
                  <Link href="/gurubas" className="w-full sm:w-auto">
                     <Button
                        variant="outline"
                        size="lg"
         ...
         <section className="py-16 md:py-24 bg-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-6">
               ...
               <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-12 gap-4">
                  ...
                  <Link href="/book" className="group flex items-center text-stone-900 font-bold hover:text-saffron-600 transition-colors bg-stone-100 hover:bg-saffron-50 px-5 md:px-6 py-3 rounded-full shadow-sm hover:shadow-md active:scale-95">
               ...
               <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                  <div className="md:col-span-1">
                     <Link href="/" className="flex items-center gap-2 mb-6">
                        <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-saffron-500 to-orange-600 flex items-center justify-center text-white font-bold text-xl shadow-lg">
                           G
                        </div>
                  ...
                  <div>
                     ...
                     <ul className="space-y-4 text-sm text-stone-400">
                        <li><Link href="/services" className="hover:text-saffron-500 transition-colors">Services</Link></li>
