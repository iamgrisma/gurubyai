            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  <Link to="/" className="flex items-center gap-4 p-3 rounded-xl text-stone-700 font-medium hover:bg-stone-50 active:bg-stone-100 transition-colors">
                  ...
                  <Link to="/gurubas" className="flex items-center gap-4 p-3 rounded-xl text-stone-700 font-medium hover:bg-stone-50 active:bg-stone-100 transition-colors">
                    <div className="h-10 w-10 rounded-full bg-stone-100 flex items-center justify-center text-stone-500">
              ...
              {session ? (
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    <Link to="/messages" className="flex items-center justify-between p-3 rounded-xl hover:bg-stone-50 transition-colors">
                      <div className="flex items-center gap-3">
